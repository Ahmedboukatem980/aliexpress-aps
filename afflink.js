...
async function fetchLinkPreview(productId) {
    // First option: linkpreview.xyz API (Now prioritized)
    try {
        console.log("Trying linkpreview.xyz API (prioritized)...");
    ...
    // Third option: External API (microlink.io)
    try {
